...
//i dont know what to do about header and footer yet
...
var List = function (_Component) {
  ...
  */
		...
		//this will fire only if the state of the parent updates passing down new props
...
var Post = function (_Component) {
	...
	_createClass(Post, [{
		...
		value: function renderPosts(post) {
			var date = (0, _moment2.default)(post.time).format('MM DD YYYY');
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'panel-heading post-title' },
					_react2.default.createElement(
						'h2',
						{ className: 'strip-top-margin strip-bottom-margin' },
						post.title
					),
					_react2.default.createElement(
						'h5',
						{ className: 'strip-top-margin add-bottom-margin' },
						date
					)
				),
				_react2.default.createElement(
					'div',
					{ className: 'panel-body post-body' },
					_react2.default.createElement(
						'p',
						null,
						post.post
...
), document.getElementById('root')); //entry for webpack
